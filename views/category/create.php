...
$this->title = 'AdminLTE 2 | Каталог - Категория - Добавление';
...
$parents = [0 => 'Нет родительской категории'] + \yourickds\adminlte\models\Category::find()->select(['name', 'id'])->indexBy('id')->asArray()->column();
?>
