...
$this->title = 'AdminLTE 2 | Каталог - Категории - ' . $model->name . ' - Редактирование';
...
$parents = \yourickds\adminlte\models\Category::find()->where(['!=', 'id', $model->id])->select(['name', 'id'])
    ->asArray()->column();
array_unshift($parents, 'Нет родительской категории');
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= \yii\helpers\Url::to(['view', 'id' => $model->id]) ?>"><?= $model->name ?></a></li>
