...
$this->title = 'AdminLTE 2 | Каталог - Категории';
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <?= Html::a('Добавить категорию', ['create'], ['class' => 'btn-sm btn-success']) ?>
                    </div>
                    <div class="box-body">
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                'attribute' => 'parent',
                                'value' => function($data){
                                    return $data->parent == 0 ? "Нет родительской категории" : $data->category->name;
                                }
                            ],
                            'name',
                            'url',
                            ...
                            [
                                'attribute' => 'status',
                                'value' => function($data){
                                    return $data->status == 1 ? "Опубликовано" : "Не опубликовано";
                                }
                            ],
                            'created_at',
                            'update_at',
                                ...
                                'buttons' => [
                                    'delete' => function($url, $model){
                                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', ['delete', 'id' => $model->id], [
                                            'class' => '',
                                            'data' => [
                                                'confirm' => 'При удалении элемента будут удалены все дочерние элементы! Вы уверены, что хотите удалить этот элемент?',
                                                'method' => 'post',
                                            ],
                                        ]);
                                    }
