...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="<?= \yii\helpers\Url::to(['mailbox/compose']) ?>" class="btn btn-primary btn-block margin-bottom">Compose</a>
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="mailbox-name"><a href="<?= \yii\helpers\Url::to(['mailbox/read']) ?>">Alexander Pierce</a></td>
...
$(function () {
    ...
    $(".mailbox-star").click(function (e) {
      e.preventDefault();
      //detect type
      var el = $(this).find("a > i");
      var glyph = el.hasClass("glyphicon");
      var fa = el.hasClass("fa");

      //Switch states
      if (glyph) {
        el.toggleClass("glyphicon-star");
        el.toggleClass("glyphicon-star-empty");
      }

      if (fa) {
        el.toggleClass("fa-star");
        el.toggleClass("fa-star-o");
      }
    });
  });
JS;
