...
$this->title = 'AdminLTE 2 | Read Mail';
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="<?= \yii\helpers\Url::to(['mailbox/index']) ?>"><i class="fa fa-inbox"></i> Inbox
                    ...
                    <div class="box-footer">
                        <ul class="mailbox-attachments clearfix">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                            ...
                            <li>
                                <span class="mailbox-attachment-icon has-img">
                                    <?= \yii\helpers\Html::img($bundle->baseUrl . '/img/photo1.png') ?>
                                </span>
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                            ...
                            <li>
                                <span class="mailbox-attachment-icon has-img">
                                    <?= \yii\helpers\Html::img($bundle->baseUrl . '/img/photo2.png') ?>
                                </span>
