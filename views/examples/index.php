    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <?= \yii\helpers\Html::img($bundle->baseUrl . '/img/credit/visa.png') ?>
                <?= \yii\helpers\Html::img($bundle->baseUrl . '/img/credit/mastercard.png') ?>
                <?= \yii\helpers\Html::img($bundle->baseUrl . '/img/credit/american-express.png') ?>
                <?= \yii\helpers\Html::img($bundle->baseUrl . '/img/credit/paypal2.png') ?>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?= \yii\helpers\Url::to(['examples/print']) ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
